...
删除repo，删不干净，无法创建同名repo
import奇慢
push大量文件提示API is not accessible
后台git推送迟迟未刷新成最新的
...
docker pull gitlab-ce:11.4.4 # 拉取指定版本 TODO
```
...
#### `The project is still being deleted`[More](https://forum.gitlab.com/t/the-project-is-still-being-deleted-please-try-again-later/6542/18)

Solution:
```
gitlab-rails console

p = Project.find_by_name "<project name without path>"
p.destroy
```

#### `The form contains the following error:
PG::UndefinedColumn: ERROR: column "wikis_count" does not exist LINE 1: UPDATE "site_statistics" SET "wikis_count" = "wikis_count"+1 ^ : UPDATE "site_statistics" SET "wikis_count" = "wikis_count"+1`
...
#### `Post "https://xxx/info/lfs/objects/batch": x509: certificate has expired or is not yet valid: current time 2024-07-24T01:23:41+08:00 is after 2020-04-26T12:00:00Z` - TODO
