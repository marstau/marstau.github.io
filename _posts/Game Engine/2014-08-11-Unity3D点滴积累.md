...
#### linear color space中移动端更暗[More](https://gameinstitute.qq.com/community/detail/114922)[More2](http://ranaitian.com/2018/04/03/unity-lightmap-on-mobile/)
...
private void OnDrawGizmos() {
    ...
    for (int i = 0; i < stepX; i++) {
        for (int j = 0; j < stepZ; j++) {
            ...
            Gizmos.DrawWireCube(mainBound.center - mainBound.size/2 + new Vector3(i*minBound.x,0,j*minBound.z), minBound);
        }
    }
}
```

#### mipmap mipBias[More](http://www.cppblog.com/shadess/archive/2012/06/12/178510.html)
