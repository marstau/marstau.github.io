...
```
ResUtil.multiSelectIconPath = {}
setmetatable(ResUtil.multiSelectIconPath, {
    __index = function(t, k)
        t[k] = string.format("Art/ModelFrame/%d", k)
        return t[k]
    end
})
function ResUtil:getMultiSelectIconPath(agentType)
    return self.multiSelectIconPath[agentType]
end
```
